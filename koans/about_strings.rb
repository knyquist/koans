...
class AboutStrings < Neo::Koan
  ...
  def test_use_flexible_quoting_to_handle_really_hard_cases
    ...
    # flexible quotes allow you to specify delimiter 
    # whatever character follows the % symbol will start/close string.
  end
...
It was the worst of times.
    ...
    assert_equal "\n", long_string[0,1] #first character folowing flex quote is new line delimiter
  end
